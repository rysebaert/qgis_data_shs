...
### Information géographique ?  (*9h - 9h30*)
...
### Systèmes d'Information Géographiques ? (*9h30 - 10h45*)
...
### Géotraitements et statistiques spatiales *(13h45 - 15h15)*
- Présentation et mise en pratique

### Mise en cohérence des critères *(15h15-15h30)*
...
Toute information contenant une référence à une localisation, qu’il s’agisse d’un **point** précis du territoire, d’**une ligne** (route, frontière, cours d'eau) ou encore d’**une surface** (aire protégée, zone d’emploi, commune...) **a une dimension géographique**.
...
```{r, echo = FALSE, out.width = "900px", fig.align='right'}
...
Le niveau topologique  **d'un objet géographique se déduit du niveau géométrique**. Il correspond aux relations éventuelles avec d'autres objets ou phénomènes.
...
<p style="line-height:1.3;font-size:11pt;font-style:italic;text-align:center;"><a href="https://openstreetmap.org/" target="_blank">openstreetmap.org</a></p>
...
<p style="line-height:1.3;font-size:11pt;font-style:italic;text-align:center;">Densité des bars à Paris avec des données OSM (<a href="https://rgeomatic.hypotheses.org/1244" target="_blank">T.Giraud, R Geomatic</a>)</p>
...
Le <a href="https://wiki.openstreetmap.org/wiki/FR:Tag:leisure%3Dsports_centre" target="_blank">wiki OpenStreetMap</a> permet d'identifier la clé-valeur OSM associée à l'objet géographique désiré. Plusieurs outils existent pour requêter ces données, comme l'<a href="https://overpass-turbo.eu/" target="_blank">API overpass-turbo</a>.
...
Les requêtes sont envoyées sur un serveur mis à disposition gratuitement. Les requêtes doivent être raisonnables (pas sur l'ensemble du Monde).  
...
Les métadonnées synthétisent des informations élémentaires et facilitent la compréhension et l'utilisation des données : **auteur·rice, date de création/modification, technique de collecte, qualité, taille du fichier, unité de mesure, droits d'utilisation...**.
...
Le SIG est également **l'outil de référence de la géomatique**
...
Les logiciels d'analyse de données (R, SAS, SPSS, etc.) permettent de traiter, explorer et analyser les données disposant d'une dimension géographique, grâce à du code, des fonctions et des librairies dédiées.

.center[
<img src="fig/rstudio.png" height="500" />
]
---
...
Des logiciels spécialement dédiés à la cartographie thématique et à la mise en page. 
...
Pour changer l'ordre d'affichage des couches, il suffit de les faire glisser dans les panneaux des couches à la position de son choix, comme des onglets dans un navigateur Web.
...
Attention néanmoins, il **manque beaucoup d'éléments** (titre, légende, sources...) etc. pour que cette carte soit valable ! Cela peut néanmoins constituer une base de travail et de réflexion. 
...
.medium[
**L'écart entre le géoïde et l'ellipsoïde de référence** (nommée 'hauteur') **ne dépasse pas 110 mètres** !  Si la forme de la terre n'est pas régulière, elle se rapproche donc fortement d'un ellipsoïde.
...
.pull-left[
<img src="fig/US.jpg" width="350" />
<br>
<img src="fig/ONU.png" width="350" />
]

.pull-right[
<img src="fig/chinese_world.jpeg" width="350" />
<br>
<img src="fig/australian.jpg" width="350" />
]
...
-  En France, tout comme dans de nombreux pays, vous êtes soumis·e à des **normes** si vous travaillez dans le cadre d'une **mission de service public.**
...
D'un point de vue général, les distorsions sont d'autant plus importantes que la surface à représenter l'est aussi.
...
Enregistrez ces couches dans votre dossier ***tmp***, puis nettoyer l'espace de travail (éviter de visualiser des couches géographiques dorénavant inutiles)
]
...
.pull-left[
## Deuxième critère : la proximité des foyers aux revenus les plus modestes
...
## La proximité des foyers aux revenus les plus modestes
...
<br>
.center[Source : *Manuel de cartographie : principes, méthodes, applications* (Lambert, Zanin, 2016)]
