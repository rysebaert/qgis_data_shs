...
.center[
<img src="fig/proj/selec_9.PNG" width="375" /><img src="fig/est_ensemble_implantation_map.PNG" width="575" />
]
...
Dans ce cas, nous souhaitons que la méthode de discrétisation permette d'identifier les 20 % des IRIS aux valeurs de revenus les plus faibles et les plus fortes. Une méthode basée sur les quantiles en 8 classes permet d'y répondre. 
La rupture de couleur n'est pas forcément une bonne chose, mais ici elle permet visuellement de séparer les unités géographiques en dessous et au-dessus de la médiane
...
- **Nombre de classes** : 8 (indice d'Huntsberger indique 1+3.3(log()))
