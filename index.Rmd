...
.center[
Importez la couche **COMMUNES_METRO_LILLE** et **IRIS_METRO_LILLE** dans QGIS
]
]
...
.right-column[
![](fig/proj/intro_4_selec_attr.PNG)
.center[
Sélectionnez les IRIS de **Lille**
]
]
...
2. Ouvrir la table d'attribut
3. Ordonner par nom de commune
4. Sélectionner les IRIS de **Lille**.
...
![](fig/export_sel.PNG)
.center[
Clic droit sur IRIS > Exporter uniquement les données sélectionnées > déposer dans le dossier "tmp" au format geojson. 
]
]
