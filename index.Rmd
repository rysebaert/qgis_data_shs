...
Cela nécessite de définir la clé-valeur de l'objet OpenStreetMap désiré grâce au <a href="https://wiki.openstreetmap.org/wiki/FR:Tag:leisure%3Dsports_centre" target="_blank">wiki OpenStreetMap</a>. Ensuite d'effectuer la requête de l'objet désiré via l'<a href="https://overpass-turbo.eu/" target="_blank">API overpass-turbo</a>.
