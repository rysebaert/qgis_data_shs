...
Puis cliquez sur *data > qgis_atelier_dataSHS.zip > download*. Décompresser ensuite l'archive. 
.center[
...
- data/GEOM/IRIS_METRO_LILLE.shp 
- data/GEOM/COMMUNES_METRO_LILLE.shp
]
]
...
.pull-left[
<img src="fig/logiciels.PNG" width="500" />
]

.pull-right[
<img src="fig/query_sig.PNG" width="500" />
]
...
L'utilisation d'un SIG nécessite de la **rigueur méthodologique** : on est vite submergé par beaucoup de fichiers.  
...
Les cartes officielles représentant la France métropolitaine doivent utiliser la projection de référence **Lambert-93**. Pour les DROM, des variations de projections cylindriques (UTM). 
...
.leg-fig[
[Source : Repères de référence géodésiques en France métropolitaine, IGN, 2022](https://geodesie.ign.fr/contenu/fichiers/documentation/pedagogiques/TransformationsCoordonneesGeodesiques.pdf)]
]
...
.pull-left[
<br>
Une **jointure attributaire** permet d"associer  **deux tables attributaires décrivant des entités communes et partageant un champ commun**. L'opération produit **une seule table** juxtaposant les champs de la table à joindre à ceux de la table d'origine.
...
---
## Accessible aux ménages les plus modestes
...
Voici représenté en bleu l'espace situé à plus de 2000 mètres d'un gymnase où une pratique du roller est inventoriée ! 
...
Objectifs d'atelier :
 ...
 - Ne sélectionner que les gymnases qui ont au moins 3 écoles à moins de 1000 mètres.
...
<img src="fig/chemin_decisionnel_vf_leg.png" width="1000"/>
...
Parmi la sélection courante de ces gymnases, sélectionnez les gymnases à plus de 2000 mètres d'un gymnase où la pratique du roller est recensée. Exportez ensuite le résultat de la sélection dans le dossier **criteres** et nommez la couche **IMPLANTATION**.
...
« *Si pour obtenir une réponse correcte et complète à une question donnée, et, toutes choses égales, une construction requiert un temps d’observation plus court qu’une autre construction, on dira qu’elle est plus efficace pour cette question* » .
...
.pull-left[
<img src="fig/VV_valeur.png" width="420" />
<img src="fig/VV_harmonique.png" width="420" />
<img src="fig/VV_intensite.png" width="420" />
<img src="fig/VV_couleur.png" width="420" />
<img src="fig/VV_taille_ordre.png" width="420" />

]

.pull-right[
<img src="fig/VV_forme.png" width="420" />
<img src="fig/VV_grain.png" width="420" />
<img src="fig/VV_orientation.png" width="420" />
<img src="fig/VV_texture_diff.png" width="420" />
...
.center[
<img src="fig/VV_prop.png" width="800" />
...
.center[
<img src="fig/VV_categories.png" width="800" />
...
.center[
<img src="fig/VV_donnee_carte.png" width="800" />
...
.center[
<img src="fig/VV_arbre.png" width="720" />
]
...
- **Discrétisation (message véhiculé par la carte**) : permettre d'identifier visuellement les 33 % des territoires au plus haut/faible revenu. 

- **Nombre de classes** : 6 (indice d'Huntsberger indique 1+3.3(log10(502)) = 9.9

- **Palette de couleurs** : Opposition rouge/bleu autour de la médiane. Usage d'une convention de couleur française (couleurs chaudes = élevé, positif / couleurs froides = faible, négatif).
]
]
...
<img src="fig/ref_4.PNG" height="400"  style="border:1px solid grey"  />
<img src="fig/ref_5.jpeg" height="400" style="border:1px solid grey"  />
<img src="fig/sig-libre.PNG" height="400" style="border:1px solid grey"  />
...
<img src="fig/ref_1.jpg" height="360" style="border:1px solid grey"  />
<img src="fig/ref_2.jpg" height="360" style="border:1px solid grey" />
<img src="fig/lambert-zanin.jpeg" height="360" style="border:1px solid grey"  />
<img src="fig/monmonier.jpg" height="360" style="border:1px solid grey"  />
...
<img src="fig/scandale.png"  width=300 style="border:1px solid grey" />
.leg-fig[ <a href="https://www.lessavoirsambulants.fr/p/le-scandale-de-mercator.html" target="_blank">Le scandale de Mercator</a>
 ]

<img src="fig/westwing.png"  width=300 style="border:1px solid grey"/>
.leg-fig[ <a href="https://www.youtube.com/watch?v=vVX-PrBRtTY" target="_blank">Extrait de *The West Wing* saison 2 épisode 16 (vostfr)</a>, <a href="https://www.youtube.com/watch?v=Mjq8sXsUS30&feature=youtu.be" target="_blank">version française</a>
]
]]
...
.pull-left[
<img src="fig/allwrong.png"  width=300 style="border:1px solid grey" />
.leg-fig[ <a href="https://www.youtube.com/watch?v=kIID5FDi2JQ" target="_blank">Why all world maps are wrong (vostfr)</a>
]

<img src="fig/truesize.png"  width=300 style="border:1px solid grey"/>
.leg-fig[ <a href="https://www.thetruesize.com" target="_blank">thetruesize.com</a>
]
]
...
<br><br><br>
<img src="fig/dessous_cartes.PNG"  width=300 style="border:1px solid grey"/>
.leg-fig[ <a href="https://https://www.youtube.com/watch?v=WJUMOyreOAM" target="_blank">*Géopolitique et usage cartographique*</a>
]
]]]
...
.pull-left[
<img src="fig/emprise1.png"  width=600 style="border:1px solid grey"/>
]

.pull-right[
<img src="fig/emprise2.png"  width=600 style="border:1px solid grey"/>
.leg-fig[*Méfiez-vous des cartes, pas des migrant·e·s (2018)*]
]
<br>
.center[sources : <a href="https://neocarto.hypotheses.org/4188" target="_blank">néocarto </a> avec une vidéo détaillant les étapes de création de ces cartes réalisées avec les mêmes données et des emprises spatiales différentes - tout est reproductible et présenté <a href="https://neocarto.github.io/syrians/" target="_blank">ici</a>
]
]
...
- Accéder à la présentation ou la réutiliser : [rysebaert.github.io/qgis_data_shs](https://rysebaert.github.io/qgis_data_shs/)
- Accéder au dépôt github (données, figures, RMardown) : [github.com/rysebaert/qgis_data_shs](https://github.com/rysebaert/qgis_data_shs)
- Pour proposer des améliorations, suggestions : [github.com/rysebaert/qgis_data_shs/issues](https://github.com/rysebaert/qgis_data_shs/issues)
...
|                                                                                                            |                                   |
| :--------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| `r icons::fontawesome("envelope")` | [violaine.jurie@u-paris.fr](mailto:violaine.jurie@u-paris.fr)       |
| `r icons::fontawesome("home")` | [geoteca.u-paris.fr/](https://geoteca.u-paris.fr/) |
| `r icons::fontawesome("gitlab")` | [gitlab.huma-num.fr/vjurie](https://gitlab.huma-num.fr/vjurie)                         |
]]
