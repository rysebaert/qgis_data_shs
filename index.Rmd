...
Une fois <a href="https://www.qgis.org/fr/site/forusers/download.html" target="_blank">installé</a>, **Lancez l'application QGIS Desktop**, comme vous le feriez avec n'importe quel logiciel :
...
- Ordonner votre travail en utilisant des **sous-répertoires**.
   ...
   * **critères** : les couches géographiques consolidées du projet. 
...
Enregistrer la sélection que vous appellerez *lille_iris* dans le dossier "tmp" au format *geojson*. 
...
L'EPSG (European Petroleum Survey Group) a construit en place une base de données qui recense et identifie les systèmes de **projection les plus utilisés**.
...
.medium[
Exportez les couches géographiques des écoles et gymnases dans le même SCR que celui des IRIS et communes (Lambert 93). 
...
- Éventuellement, rajouter des labels pour faciliter la localisation
...
**IL FAUT ETRE EN MESURE DE JUSTIFIER SES CHOIX**
]
]
...
- Classes les valeurs du champ (toutes valeurs uniques)
...
<img src="fig/magrit_project.png" width="500"/>
